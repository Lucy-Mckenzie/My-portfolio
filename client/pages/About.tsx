...
export default function About() {
  ...
  return (
    ...
    <h1 className='font-light text-8xl text-[#213b73] font-merriweather z-10'>
      Hi, I&apos;m Lucy
      </h1>
      <img src='/images/sun.png' alt='sun' className='absolute bottom-20 z-0 max-w-[600px] max-h-[500px] animate-glow-spin'></img>
    <p className='text-[#213b73] text-lg mt-4 py-3 z-10 text-left max-w-[570px]'>
